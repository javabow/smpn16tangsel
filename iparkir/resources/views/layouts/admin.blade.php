				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark ">
					<!-- BEGIN: Aside Menu -->
						...
						<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
							...
							<li class="m-menu__item " aria-haspopup="true" >
								<a  href="{{ url('admin/tenants') }}" class="m-menu__link ">
									<span class="m-menu__item-here"></span>
							...
							<li class="m-menu__item " aria-haspopup="true" >
								<a  href="{{ url('admin/promosi-tenants') }}" class="m-menu__link ">
									<span class="m-menu__item-here"></span>
							...
							<li class="m-menu__item link-comments" aria-haspopup="true" >
								<a  href="{{ url('admin/comments') }}" class="m-menu__link ">
									<span class="m-menu__item-here"></span>
