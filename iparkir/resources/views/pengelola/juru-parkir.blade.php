...
@section('title')
Admin Page Pengelola Parkir | Juru Parkir
@endsection
...
@section('content')
  <div id="content-cont" class="container bg-light p-4">
    ...
    <p>
      <a class="btn btn-info" href="{{ url('admin/pengelola-parkir/juru-parkir/create') }}">Add Juru Parkir <i class="fas fa-plus"></i></a>
    </p>
      ...
      <tbody>
        @foreach ($users as $user)
          <tr val="{{ $user->id }}">
            ...
            <td class="row">
              <form class="col-md-6 p-0" action="{{ url('admin/pengelola-parkir/juru-parkir/'.$user->id.'/edit') }}" method="get">
                <button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit"></i> </button>
              </form>
              <form id="delete" class="col-md-6 p-0" action="{{ url('admin/pengelola-parkir/juru-parkir/'.$user->id) }}" method="post">
