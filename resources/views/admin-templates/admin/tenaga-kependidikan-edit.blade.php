...
@section('title')
Admin Page SMKN 16 Tangerang Selatan | Staff - Tenaga Kependidikan - Edit
@endsection
@section('title-header')
  Edit Staff - Tenaga Kependidikan
@endsection
@section('content')
  <div id="content-cont" class="container bg-light p-4">
    @include('admin-templates.alert-box')
    <form action="{{ url('admin/tenaga-kependidikan/'.$staff->id) }}" method="post">
