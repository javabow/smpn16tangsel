            ...
            <div class="blog-items">
                ...
                <div class="blog-content col-md-8">
                    ...
                    <div class="single-item">
                        <div class="item">
                            <div class="thumb">
                                <a href="#"><img src="{{asset('img/dummy-img.png')}}" style="width: 100%" alt="Thumb"></a>
                                <div class="date">
                    ...
                    <div class="row">
                        <div class="col-md-12 pagi-area">
                            <nav aria-label="navigation">
                                <ul class="pagination"><li class="active"><a>1</a></li><li><a href="#" data-ci-pagination-page="2">2</a></li><li><a href="#" data-ci-pagination-page="2" rel="next">Next</a></li></ul>                            </nav>
                        </div>
                    </div>
                </div>
                <!-- Start Sidebar -->
